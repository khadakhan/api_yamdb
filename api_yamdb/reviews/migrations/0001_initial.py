# Generated by Django 3.2 on 2024-06-14 14:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(blank=True, default=0, max_length=6)),
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким ником уже существует.'}, max_length=150, unique=True, validators=[reviews.validators.validate_username_me, django.contrib.auth.validators.UnicodeUsernameValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(validators=[reviews.validators.lte_current_year_validator], verbose_name='Год создания произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(10, message='Оценка должна быть не более 10'), django.core.validators.MinValueValidator(1, message='Оценка должна быть не менее 1')], verbose_name='Оценка произведения')),
