# Generated by Django 3.2 on 2024-06-15 09:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'username': 'Пользователь с таким ником уже существует.'}, max_length=150, unique=True, validators=[reviews.validators.validate_username_me, django.contrib.auth.validators.UnicodeUsernameValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(limit_value=10, message='Оценка должна быть не более 10'), django.core.validators.MinValueValidator(limit_value=1, message='Оценка должна быть не менее 1')], verbose_name='Оценка произведения')),
